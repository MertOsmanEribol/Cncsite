  ...
  return (
    <div>
        ...
        <img 
          ...
          src="./src/assets/Imgs/hakkimizda.png" 
          alt="Mühendislik" 
        />
        <div className="absolute inset-0 flex items-center justify-center z-20">
          <div className="text-center text-white">
            ...
            <h2 className="text-2xl font-light">Kapsam Makina Hakkında</h2>
          </div>
        </div>
      </div>
